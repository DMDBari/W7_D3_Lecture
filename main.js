...
// Create a function called destructed that recieves the destructMe dictionary using destructuring. Destruct the title body and author and leave the rest of the attributes in a paramet called others. Print out the title, body, and autor to the console. Then print the entire contents of other to the console.
...
// Same then applies to Array - because Array is an object
let arr1 = [1, 2, 3];
let arr2 = [1, 2, 3];
let arr3 = arr1;
...
// remember all non-zero number are true, but 0 is false
...
for (let i=0; i < Object.keys(person1).length; i++){
    ...
    console.log('Values:', Object.values(person1)[i])
    console.log('Value2:', person1[Object.keys(person1)[i]])
}


// ES6 Marked the introduction of the fo...in loop!
...
let euroCountries = ['Spain', 'France', 'Englane', 'Germany', 'Poland', 'Italy']
...
console.log(typeof euroCountries)
